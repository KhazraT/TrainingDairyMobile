...
public class StatisticsFragment extends Fragment {
    ...
    private void displaySetsChart(List<MuscleSetsStats> stats) {
        ...
        // Полный список групп мышц (из справочника базы данных)
        String[] allMuscleGroups = {
            "Шея", "Трапеция", "Грудь", "Бицепс", "Трицепс", "Спина", "Пресс",
            "Квадрицепс", "Бицепс бедра", "Ягодичные", "Икроножные", "Плечи", "Поясница", "Кардио"
        };
